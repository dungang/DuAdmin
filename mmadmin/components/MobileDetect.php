...
class MobileDetect
{
     ...
     * So HTTP_USER_AGENT and SERVER_SOFTWARE.
     *
     * @var array
     */
    ...
    /**
     * CloudFront headers.
     * E.g. CloudFront-Is-Desktop-Viewer, CloudFront-Is-Mobile-Viewer & CloudFront-Is-Tablet-Viewer.
     *
     * @var array
     */
     ...
     * Must be PHP-flavored. This method will reset existing headers.
     *
     ...
     * If it doesn't exist, no exception/error is caused.
     ...
     * Must be one of self::DETECTION_TYPE_MOBILE or
    ...
    public function mobileGrade()
    {
        ...
        $this->is('iOS') && $this->version('iPad', self::VERSION_TYPE_FLOAT) >= 4.3 || $this->is('iOS') && $this->version('iPhone', self::VERSION_TYPE_FLOAT) >= 4.3 || $this->is('iOS') && $this->version('iPod', self::VERSION_TYPE_FLOAT) >= 4.3 ||
            ...
            ($this->version('Android', self::VERSION_TYPE_FLOAT) > 2.1 && $this->is('Webmmadmin')) || 

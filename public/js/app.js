...
var App = {
		resetSimpleModal: function(modalSelector) {
			$(modalSelector).on('hidden.bs.modal', function() { $(this).removeData('bs.modal')});
...
//            $(document).on('submit',modalSelector,function(event){
//            	console.log(event);
//            	
//            	return false;
//            });

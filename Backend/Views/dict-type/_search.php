...
/* @var $model DuAdmin\Models\DictTypeSearch */
...
<div class="dict-type-search">
    ...
    <?php $form = ActiveForm::begin([
        ...
        'options' => [
                'data-pjax' => 1,
                'onsubmit' => "\$('#dict-type-search-modal').modal('hide')"
        ],
    ]); ?>
<div class="row">
    <?= '<div class="col-xs-6">' . $form->field($model, 'id') . '</div>' ?>

    <?= '<div class="col-xs-6">' . $form->field($model, 'dictName') . '</div>' ?>

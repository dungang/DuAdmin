...
/* @var $model Backend\Models\AuthRoleSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<?php

\yii\bootstrap\Modal::begin([
    'id' => 'auth-role-search-modal','header' => '高级搜索','toggleButton' => [
        'label' => '<i class="fa fa-search"></i> 高级搜索','class' => 'btn btn-warning'
    ],
]);
?>
...
$form = ActiveForm::begin([
        'action' => [
            ...
            'data-pjax' => 1,'onsubmit' => "\$('#auth-role-search-modal').modal('hide')"
        ],
    ]);
    ?>
<div class="row">

...
class AuthItem extends \DuAdmin\Core\BaseModel
{
    ...
    public function rules()
    {
        return [
            [
                ...
                [
                    'ruleId'
                ],'exist','skipOnError' => true,'targetClass' => AuthRule::class,'targetAttribute' => [
                    'ruleId' => 'id'
                ]
            ],
        ];
    ...
    {
        return [
            'id' => Yii::t('app_auth_item', 'ID'),'type' => Yii::t('app_auth_item', 'Type'),'name' => Yii::t('app_auth_item', 'Name'),'ruleId' => Yii::t('app_auth_item', 'Rule ID'),'data' => Yii::t('app_auth_item', 'Data'),'sort' => Yii::t('app_auth_item', 'Sort'),'createdAt' => Yii::t('app_auth_item', 'Created At'),'updatedAt' => Yii::t('app_auth_item', 'Updated At'),
        ];
    }
    ...
    {
        return [
            'id' => '路由ID或者角色，组的英文表示','type' => '1:角色|2:权限|3:组',
        ];
    }

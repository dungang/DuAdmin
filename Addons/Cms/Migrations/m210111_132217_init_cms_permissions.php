...
class m210111_132217_init_cms_permissions extends Migration
{
    ...
    public function safeUp()
    {
        ...
        InstallerHelper::installAddonPermission("cms", "内容模块管理");
        InstallerHelper::installPermissionCRUDShortcut("文章分类", "cms/category", "cms");
        ...
        InstallerHelper::installPermissionCRUDShortcut("文章", "cms/post", "cms");
        InstallerHelper::installPermissionCRUDShortcut("轮播图", "cms/flash", "cms");
        InstallerHelper::installPermissionCRUDShortcut("单页", "cms/page", "cms");
        InstallerHelper::installPermissions([
            [
        ...
        InstallerHelper::installPermissionCRUDShortcut("友情链接", "cms/friend-link", "cms");
        InstallerHelper::installPermissionCRUDShortcut("广告位", "cms/adv-block", "cms");

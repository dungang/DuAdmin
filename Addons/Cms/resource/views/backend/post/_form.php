...
$form = ActiveForm::begin( [
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <?=$form->field( $model, 'cover' )->widget( AjaxFileInput::class, [ 'clip' => AppHelper::getSetting( 'cms.post.clip', 'true' ),'compress' => AppHelper::getSetting( 'cms.post.compress', 'true' ),'clipWidth' => AppHelper::getSetting( 'cms.post.clipWidth', 480 ),'clipHeight' => AppHelper::getSetting( 'cms.post.clipHeight', 320 )] )?>

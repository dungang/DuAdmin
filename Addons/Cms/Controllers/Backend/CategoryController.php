...
/**
 * Category 模型的控制器
 * CategoryController 实现了常规的增删查改等行为
 */
class CategoryController extends BackendController
{
    ...
    public function actionIndex()
    {
        ...
        $models = Category::find()->asArray()->orderBy('sort')->all();

...
<div class="friend-link-form">
    ...
    <div class="row">
        ...
        <?='<div class="col-xs-6">' . $form->field( $model, 'pid' )->dropDownList( FriendLink::getMapWidthDep(), [ 'prompt' => ''] ) . '</div>'?>

		<?='<div class="col-xs-6">' . $form->field( $model, 'type' )->dropDownList( [ 'url' => '链接','email' => '邮件','tel' => '电话','qrcode' => '二维码'], [ 'prompt' => ''] ) . '</div>'?>

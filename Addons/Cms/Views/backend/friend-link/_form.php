...
<div class="friend-link-form">
    ...
    <?php $form = ActiveForm::begin(['id' => 'friend-link-form', 'enableAjaxValidation' => true, 'action' => $action]); ?>
    <div class="row">
        <?= '<div class="col-xs-12">' . $form->field($model, 'name')->textInput() . '</div>' ?>

        <?= '<div class="col-xs-12">' . $form->field($model, 'pid')->dropDownList(FriendLink::getMapWidthDep(), ['prompt' => '']) . '</div>' ?>

	...
	*/
	...
	htmlUpdateTransform: function () {
		...
		if (elem.tagName === 'SPAN') {
			...
			// force reflow in webmmadmin to apply the left and top on useHTML element (#1249)
			if (isWebKit) {
	...
	setSpanRotation: function (rotation) {
		var rotationStyle = {},
			cssTransformKey = isIE ? '-ms-transform' : isWebKit ? '-webmmadmin-transform' : isFirefox ? 'MozTransform' : isOpera ? '-o-transform' : '';
...
SVGRenderer.prototype = {
	...
	color: function (color, elem, prop) {
		...
		// Webmmadmin and Batik can't show rgba.
...
Chart.prototype = {
	...
	getContainer: function () {
		...
		chart.container = container = createElement(DIV, {
				...
				zIndex: 0, // #1072
				'-webmmadmin-tap-highlight-color': 'rgba(0,0,0,0)'
			}, optionsChart.style),

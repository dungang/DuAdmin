...
// Old Android is defined as Version older than 2.3, and requiring a webmmadmin version of the android browser
vjs.IS_OLD_ANDROID = vjs.IS_ANDROID && (/webmmadmin/i).test(vjs.USER_AGENT) && vjs.ANDROID_VERSION < 2.3;
...
vjs.setLocalStorage = function(key, value){
  try {
    ...
    if (e.code == 22 || e.code == 1014) { // Webmmadmin == 22 / Firefox == 1014
...
// Then with the new fullscreen API, Mozilla and webmmadmin browsers will reload the flash object after going to fullscreen.
...
vjs.Player.prototype.trackCurrentTime = function(){
  ...
  }), 250); // 42 = 24 fps // 250 is what Webmmadmin uses // FF uses 15
};
...
(function(){
  ...
  // Webmmadmin (Chrome/Safari) and Mozilla (Firefox) have working implementations
...
vjs.Html5.prototype.supportsFullScreen = function(){
  if (typeof this.el_.webmmadminEnterFullScreen == 'function') {
...
vjs.Html5.prototype.enterFullScreen = function(){
  ...
  if (video.paused && video.networkState <= video.HAVE_METADATA) {
    ...
    setTimeout(function(){
      video.pause();
      video.webmmadminEnterFullScreen();
    }, 0);
  } else {
    video.webmmadminEnterFullScreen();
  }
...
vjs.Html5.prototype.exitFullScreen = function(){
  this.el_.webmmadminExitFullScreen();
};
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // - Webmmadmin when hiding the plugin
    // - Webmmadmin and Firefox when using requestFullScreen on a parent element
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      // This works in webmmadmin but still triggers the firefox security error

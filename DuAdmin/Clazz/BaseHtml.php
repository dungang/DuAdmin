...
class BaseHtml
{
    ...
    public static function getViewInputId()
    {
        ...
        if ( empty( static::$viewInputIdMap[ $view ] ) ) {
            static::$viewInputIdMap[ $view ] = substr( md5( $view ), -8 );
        }
        return static::$viewInputIdMap[ $view ];
    }
    ...
    public static function getInputId( $model, $attribute )
    {
        ...
        return self::getViewInputId() . '-' . str_replace( ['[]', '][', '[', ']', ' ', '.'], ['', '-', '-', '', '-', '-'], $name );
    }

...
abstract class JWTUser extends BaseModel  implements IdentityInterface
{
    ...
    public static function findIdentityByAccessToken($token, $type = null)
    {
        ...
        try {
            $decoded = JWT::decode($token, Yii::$app->jwtSecret, [static::getAlgo()]);
        } catch (\Exception $e) {
            return false;
        }
    ...
    public function getJWT()
    {
        ...
        return JWT::encode($token, Yii::$app->jwtSecret, static::getAlgo());
    }
}
